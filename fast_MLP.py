...
class Layer:
    ...
    def __init__(self, shape, activation, previous_layer):
        ...
        self.number_of_parameter = shape * self.previous_layer.shape + shape 
    def activate(self):
    ...
    def num_of_parameters(self):
        return self.number_of_parameter + self.previous_layer.num_of_parameters()
...
class Model:
    ...
    def __init__(self, input, output):
        self.input = input
        self.output = output
        self.number_of_parameters = output.num_of_parameter()
